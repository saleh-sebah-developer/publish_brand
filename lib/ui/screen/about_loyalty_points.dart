...
class AboutLoyaltyPointsScreen extends StatefulWidget {
  const AboutLoyaltyPointsScreen({Key key}) : super(key: key);

  @override
  State<AboutLoyaltyPointsScreen> createState() => _AboutLoyaltyPointsScreenState();
}

class _AboutLoyaltyPointsScreenState extends State<AboutLoyaltyPointsScreen> {
  @override
  void initState() {
    super.initState();
    Provider.of<HomeProvider>(context, listen: false).pageDetails(4);
  }
  @override

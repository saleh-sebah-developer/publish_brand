...
class ServicePoliciesScreen extends StatefulWidget {
  const ServicePoliciesScreen({Key key}) : super(key: key);

  @override
  State<ServicePoliciesScreen> createState() => _ServicePoliciesScreenState();
}

class _ServicePoliciesScreenState extends State<ServicePoliciesScreen> {
  @override
  void initState() {
    super.initState();
    Provider.of<HomeProvider>(context, listen: false).pageDetails(9);
  }
  @override

                            ...
                            GestureDetector(
                              onTap: () async {
                                ...
                                Provider.of<SalehProvider>(
                                    context, listen: false).download2(
                                    widget.contract);
/*
                            ...
                            */
                            ...
                            CustomTextField(
                              ...
                              labelTextHint:
                              providerHome.platformFile.toString().isEmpty
                                  ? 'hint_details_of_the_required_package'.tr()
                                  :  providerHome.platformFile.toString().split('/').last,
                              validationFun: providerAuth.validateNull,
                            ),
                            GestureDetector(
                              onTap: () async {
                               providerHome.uploadFile(context) as String;
                                print('upload file');
                              },
                              child: Container(
                            ...
                            GestureDetector(
                              onTap: () {
                                providerHome.platformFile.path.isEmpty?log('fales'):log('true');

...
class PaymentConfirmation1Screen extends StatefulWidget {
  ...
  @override
  State<PaymentConfirmation1Screen> createState() => _PaymentConfirmation1ScreenState();
}

class _PaymentConfirmation1ScreenState extends State<PaymentConfirmation1Screen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:
      Consumer2<HomeProvider,ApiAuthProvider>(builder: (context, providerHome,providerAut, x) {
        return   Form(
          ...
          child: ListView(
            children: [
                    ...
                    ExpansionTile(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            widget.price +' / '+ widget.monthsCount+'month'.tr(),
                            style: TextStyle(
                                fontSize: 20.sp, fontFamily: 'TajawalBold'),
                          ),
                        ),
                      ],
                    ),
              ...
              Container(
                ...
                child: Text(
                    'please_choose_the_payment_method_suitable_for_you'.tr(),
                    style: TextStyle(
                        fontSize: 14.sp,
              ...
              GestureDetector(
                onTap: providerHome.btnIsEnable?() {
                  ...
                  providerHome.requestPackages(context,widget.file);
                  /*

...
class ServiceDetailsTextScreen extends StatefulWidget {
  const ServiceDetailsTextScreen({Key key}) : super(key: key);

  @override
  State<ServiceDetailsTextScreen> createState() => _ServiceDetailsTextScreenState();
}

class _ServiceDetailsTextScreenState extends State<ServiceDetailsTextScreen> {
  @override
  void initState() {
    super.initState();
    Provider.of<HomeProvider>(context, listen: false).pageDetails(7);
  }
